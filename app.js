...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Halogen.Headless.AccordionItem"] = $PS["Halogen.Headless.AccordionItem"] || {};
  var exports = $PS["Halogen.Headless.AccordionItem"];
  var Data_Function = $PS["Data.Function"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  ...
  var defaultRenderOptions = {
      ...
      renderPanel: Data_Function["const"](Halogen_HTML_Elements.div)
  };
  var defaultOpenOptions = {
      open: false,
      onOpenChange: Data_Maybe.Nothing.value
  };
  var defaultOptions = Record.merge()()(defaultRenderOptions)(defaultOpenOptions);
          ...
          return function (panelId) {
              return function (triggerContent) {
                  return function (panelContent) {
                      return Halogen_HTML_Elements.div_([ v.renderHeading([  ])([ v.renderTrigger(v.open)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.id(triggerId), Halogen_HTML_Properties_ARIA.controls(panelId), Halogen_HTML_Properties_ARIA.expanded((function () {
                          if (v.open) {
                              return "true";
                          };
                          return "false";
                      })()) ])((function () {
                          if (v.onOpenChange instanceof Data_Maybe.Just) {
                              return [ Halogen_HTML_Events.onClick(function (v1) {
                                  return v.onOpenChange.value0(!v.open);
                              }) ];
                          };
                          if (v.onOpenChange instanceof Data_Maybe.Nothing) {
                              return [  ];
                          };
                          throw new Error("Failed pattern match at Halogen.Headless.AccordionItem (line 87, column 19 - line 89, column 34): " + [ v.onOpenChange.constructor.name ]);
...
(function($PS) {
  ...
  var Data_Unit = $PS["Data.Unit"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_Headless_AccordionItem = $PS["Halogen.Headless.AccordionItem"];
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Stories.AccordionItem"] = $PS["Stories.AccordionItem"] || {};
  var exports = $PS["Stories.AccordionItem"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  ...
  var component = function (dictMonadEffect) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Hooks_Hook.pure(Halogen_Headless_AccordionItem.accordionItem({
                  renderHeading: function (p) {
                      return Halogen_HTML_Elements.h3(Data_Semigroup.append(Data_Semigroup.semigroupArray)(p)([ Halogen_HTML_Properties.style("margin: 0") ]));
                  },
                  renderTrigger: Halogen_Headless_AccordionItem.defaultOptions.renderTrigger,
                  renderPanel: Halogen_Headless_AccordionItem.defaultOptions.renderPanel,
                  open: Halogen_Headless_AccordionItem.defaultOptions.open,
                  onOpenChange: Halogen_Headless_AccordionItem.defaultOptions.onOpenChange
              })("trigger")("content")([ Halogen_HTML_Core.text("trigger") ])([ Halogen_HTML_Core.text("content") ]));
          };
      });
  };
  exports["component"] = component;
...
(function($PS) {
  ...
  var Stories_AccordionItem = $PS["Stories.AccordionItem"];
  var Stories_Index = $PS["Stories.Index"];                
  var stories = function (dictMonadEffect) {
      return Foreign_Object.fromFoldable(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("", Stories_Index.component), new Data_Tuple.Tuple("Accordion", Stories_Accordion.component(dictMonadEffect)), new Data_Tuple.Tuple("AccordionItem", Stories_AccordionItem.component(dictMonadEffect)) ]);
  };
