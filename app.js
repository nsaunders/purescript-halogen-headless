...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Site.Page.Accordion"] = $PS["Site.Page.Accordion"] || {};
  var exports = $PS["Site.Page.Accordion"];
  ...
  var items = Data_Functor.mapFlipped(Data_Functor.functorArray)([ new Data_Tuple.Tuple(1, new Data_Tuple.Tuple("What is a headless component?", "\x0a    A headless component addresses concerns like state, accessibility, and\x0a    keyboard support while allowing you to focus on implementing your own\x0a    visual design.\x0a    ")), new Data_Tuple.Tuple(2, new Data_Tuple.Tuple("Is the Accordion component accessible?", "\x0a    The Accordion component implements the WAI-ARIA Accordion Design Pattern\x0a    which provides an accessible markup structure to support screen reader\x0a    and keyboard users.\x0a    ")), new Data_Tuple.Tuple(3, new Data_Tuple.Tuple("How can I customize the Accordion component?", "\x0a    The Accordion component provides minimalistic default HTML. You can\x0a    provide your own functions to render the desired heading, trigger, and\x0a    panel markup.\x0a    ")) ])(function (v) {
      return new Data_Tuple.Tuple(v.value0, new Data_Tuple.Tuple(Halogen_HTML_Core.text(v.value1.value0), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_(hstyles.content) ])([ Halogen_HTML_Core.text(v.value1.value1) ])));
  });
  ...
  var renderPanel = function (v) {
      return function (props) {
          return function (content) {
              return Halogen_HTML_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.class_(hstyles.panel), Halogen_HTML_CSS.style(Data_Maybe.fromMaybe(Control_Applicative.pure(CSS_Stylesheet.applicativeStyleM)(Data_Unit.unit))(Data_Functor.map(Data_Maybe.functorMaybe)(function ($38) {
                  return CSS_Geometry.height(CSS_Size.px($38));
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Site.Page.Index"] = $PS["Site.Page.Index"] || {};
  var exports = $PS["Site.Page.Index"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_HTML_Properties = $PS["Halogen.HTML.Properties"];
  var Halogen_Hooks_Component = $PS["Halogen.Hooks.Component"];
  ...
  var component = Halogen_Hooks_Component.component(function (v) {
      return function (v1) {
          return Halogen_Hooks_Hook.pure(Halogen_HTML_Elements.section_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Halogen Headless") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("\x0a         Halogen Headless is a new, work-in-progress component library for\x0a         "), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("https://github.com/purescript-halogen/purescript-halogen") ])([ Halogen_HTML_Core.text("Halogen") ]), Halogen_HTML_Core.text("\x0a         that attempts to solve concerns like state management, keyboard support,\x0a         and accessibility while allowing you to implement your own visual\x0a         designs.\x0a         ") ]) ]));
      };
  });
  exports["component"] = component;
})(PS);
(function($PS) {
  ...
  var Site_Page_Accordion = $PS["Site.Page.Accordion"];
  var Site_Page_Index = $PS["Site.Page.Index"];                
  var pages = function (dictMonadEffect) {
      return Foreign_Object.union(Site_Page_Accordion.demos(dictMonadEffect))(Foreign_Object.insert("")(Site_Page_Index.component)(Foreign_Object.empty));
  };
