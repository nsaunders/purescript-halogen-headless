...
(function($PS) {
  ...
  var selectionModeSingleMaybe = {
      ...
      selectionToArray: function (v) {
          var $56 = Data_Maybe.fromMaybe([  ]);
          var $57 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_Array.singleton);
          return function ($58) {
              return $56($57($58));
          };
      },
          ...
          return function (panelId) {
              return function (triggerContent) {
                  return function (panelContent) {
                      return Halogen_HTML_Elements.div_([ v.renderHeading([  ])([ v.renderTrigger(v.open)([ Halogen_HTML_Properties.id(triggerId), Halogen_HTML_Properties_ARIA.controls(panelId), Halogen_HTML_Properties_ARIA.expanded((function () {
                          if (v.open) {
                              return "true";
                          };
                          return "false";
                              ...
                              var handler = function (f) {
                                  return function (s) {
                                      return Control_Bind.bind(Halogen_Hooks_HookM.bindHookM)(Halogen_Hooks_HookM.modify(v1.value1)(f(s)))(function (sel) {
                                          ...
                                          throw new Error("Failed pattern match at Halogen.Headless.Accordion (line 118, column 11 - line 122, column 24): " + [ v.onValueChange.constructor.name ]);
                                      });
                                  };
                              };
                              var select = handler(function (x) {
                                  var $59 = Data_Maybe.fromMaybe(Control_Category.identity(Control_Category.categoryFn))(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Array.take)(selectionLimit(dictSelectionMode)(v.mode)));
                                  var $60 = Data_Array.cons(x);
                                  return function ($61) {
                                      return $59($60($61));
                                  };
                              });
...
(function($PS) {
          ...
          return function (v1) {
              return Halogen_Hooks_Hook.bind(Halogen_Hooks.useState([  ]))(function (v2) {
                  return Halogen_Hooks_Hook.bind(Halogen_Headless_Accordion.useAccordion(Data_Eq.eqInt)(dictMonadEffect)(Halogen_Headless_Accordion.selectionModeMultipleArra)((function () {
                      ...
                      return {
                          renderHeading: v3.renderHeading,
                          renderTrigger: v3.renderTrigger,
                          renderPanel: v3.renderPanel,
  ...
  var multipleUncontrolled = function (dictMonadEffect) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Headless_Accordion.useAccordion(Data_Eq.eqInt)(dictMonadEffect)(Halogen_Headless_Accordion.selectionModeMultipleArra)(Halogen_Headless_Accordion.defaultOptions(Halogen_Headless_Accordion.selectionModeMultipleArra)(Halogen_Headless_Accordion.Multiple.value))(items);
          };
      });
  };
  ...
  var singleUncontrolled = function (dictMonadEffect) {
      return Halogen_Hooks_Component.component(function (v) {
          return function (v1) {
              return Halogen_Headless_Accordion.useAccordion(Data_Eq.eqInt)(dictMonadEffect)(Halogen_Headless_Accordion.selectionModeSingleMaybe)(Halogen_Headless_Accordion.defaultOptions(Halogen_Headless_Accordion.selectionModeSingleMaybe)(Halogen_Headless_Accordion.Single.value))(items);
          };
      });
  };
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Stories.Index"] = $PS["Stories.Index"] || {};
  var exports = $PS["Stories.Index"];
  var Halogen_HTML_Core = $PS["Halogen.HTML.Core"];
  var Halogen_HTML_Elements = $PS["Halogen.HTML.Elements"];
  var Halogen_Hooks_Component = $PS["Halogen.Hooks.Component"];
  var Halogen_Hooks_Hook = $PS["Halogen.Hooks.Hook"];                
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Stories.Main"] = $PS["Stories.Main"] || {};
  var exports = $PS["Stories.Main"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Foreign_Object = $PS["Foreign.Object"];
  ...
  var Stories_Accordion = $PS["Stories.Accordion"];
  var Stories_Index = $PS["Stories.Index"];                
  var stories = function (dictMonadEffect) {
      return Foreign_Object.insert("")(Stories_Index.component)(Foreign_Object.union(Stories_Accordion.stories(dictMonadEffect))(Foreign_Object.empty));
  };
