  ...
  var renderPanel = function (v) {
      return function (props) {
          return function (content) {
              return Halogen_HTML_Elements.div(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Halogen_HTML_Properties.class_(hstyles.panel), Halogen_HTML_Properties.style(Data_Maybe.fromMaybe("")(Data_Functor.map(Data_Maybe.functorMaybe)(function (h) {
                  return "height: " + (Data_Show.show(Data_Show.showNumber)(h) + "px");
